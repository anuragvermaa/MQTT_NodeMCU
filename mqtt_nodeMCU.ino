...
#define MQTT_SERVER      "192.168.0.108"  // give static address
...
void loop() { 
 ...
 while ((subscription = mqtt.readSubscription())) { 
  ...
  if(current_sensor_data!=last_sensor_data)
  {
    pi_led.publish(current_sensor_data);
    Serial.println(current_sensor_data);
  }
} 
